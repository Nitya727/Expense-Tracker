...
export const rents = <i className="fa-solid fa-house"></i>
export const business = <i class="fa-thin fa-business-time"></i>
export const insurance = <i class="fa-light fa-shield-check"></i>
...
export const calender = <i className="fa-solid fa-calendar" style={{color: '#3fd8ff'}}></i>
export const comment = <i className="fa-solid fa-comment"></i>
export const plus = <i className="fa-solid fa-plus"></i>
export const trash = <i className="fa-solid fa-trash" style={{color: 'red'}}></i>
